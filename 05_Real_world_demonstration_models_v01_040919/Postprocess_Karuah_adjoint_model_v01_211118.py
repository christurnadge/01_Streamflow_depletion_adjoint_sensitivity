...
wflx = 1.
nlay, nrow, ncol, nstp = 2, 405, 95, 365
delr, delc = 90., 90.
scalar, offset = 1., 100.
hds = flopy.utils.binaryfile.HeadFile('karuah-base_0000_ADJ.hds')
adj = hds.get_alldata()
...
ibd01 = np.loadtxt('km-cells.csv', delimiter=',')

f,s = plt.subplots(1, 1, figsize=[7.50/2.54, 18.00/2.54])
...
s.set_title('Karuah model', fontsize=8)
plt.colorbar(p, ax=s)
...
f.tight_layout()
f.savefig('Postprocess_Karuah_adjoint_model_v01_211118.png', dpi=500 )
