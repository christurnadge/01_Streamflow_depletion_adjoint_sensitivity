...
FWDmodelname         = '04_Cumulative_depletion_Hunt_FWD'
ADJmodelname         = '04_Cumulative_depletion_Hunt_ADJ'
totim                = 365.
...
f.tight_layout()
f.savefig('04_Cumulative_depletion_Hunt_vs_FWD_vs_ADJ_v03_160519.png', dpi=500)
plt.close(f)
