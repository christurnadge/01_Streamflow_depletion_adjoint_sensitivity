...
FWDmodelname         = '01_Instantaneous_depletion_TGB_FWD'
ADJmodelname         = '01_Instantaneous_depletion_TGB_ADJ'
totim                = 365.
...
f.tight_layout()
f.savefig('01_Instantaneous_depletion_TGB_vs_FWD_vs_ADJ_v01_141118.png', dpi=500)
plt.close(f)
